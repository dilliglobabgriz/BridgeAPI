...
public class DeprecatedGameService {
    ...
    // /**
    //  * NEEDS IMPLEMENTED
    //  * Populate the game's bidhistory object with bids from players until 3 passes
    //  */
    // public void getBids() {
    //     BidHistory bids = game.getBidHistory();
    //     Player.Direction bidDirection = game.getDealer();

    //     while (!bidHistoryService.isBiddingDone(bids)) {
    //         // Prompt each player by direction to get their bids
    //         bidDirection = game.getNextPlayerDirection(bidDirection);
    //     }
    // }
